...
# POP_1990 <- read_excel(tf)
#
# YEAR <- 2010
# YEAR2 <- 2000
# SF1_VARS_2010 <- load_variables(2010, "sf1")
# SF1_VARS_2000 <- load_variables(2000, "sf1")
# 
# #2000 HH POP DATA
...
#   y <- grep(pop_tables2[i], SF1_VARS_2000$name)
#   var_list2 <- c(var_list2, y)
# }
# pop_2000 <- SF1_VARS_2000[var_list2,]
# 
...
#   x <- grep(pop_tables1[i], SF1_VARS_2010$name)
#   var_list1 <- c(var_list1, x)
# }
# pop_2010 <- SF1_VARS_2010[var_list1,]
# 
...
#   p <- map_dfr(
#     YEAR,
#     ~ get_decennial(geography = "county", variables = pop_2010$name,
